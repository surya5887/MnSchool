...
const ReportCardPrintView: React.FC<ReportCardProps> = ({ students, classes, className, maxMarks, onClose }) => {
  ...
  if (loading) return <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: '#e5e7eb', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Loader className="spin" size={48} /></div>;
