      ...
      <style>
          {`
            @media print {
              ...
              .cc-inner-border, .bc-inner-border { padding: 80px 40px !important; border: 2px solid #b91c1c !important; margin: 4px !important; height: calc(100vh - 24px) !important; box-sizing: border-box !important; display: flex; flex-direction: column; }
          ...
          <div className="bc-content-z">
             ...
             <div style={{ fontSize: '20px', lineHeight: '1.8', textAlign: 'justify', marginTop: '10px' }}>
                  <p style={{ margin: '0 0 15px 0', textIndent: '50px' }}>
                     This is to certify from the school records that <span contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, studentName: e.currentTarget.textContent || ""})} style={{ border: "none", outline: "none", background: "transparent", fontWeight: "bold", fontFamily: "inherit", fontSize: "inherit", padding: 0, textAlign: "center", color: '#b91c1c', textTransform: 'uppercase' , cursor: "text"}}>{formData.studentName}</span>, 
                     son/daughter of Shri <span contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, fatherName: e.currentTarget.textContent || ""})} style={{ border: "none", outline: "none", background: "transparent", fontWeight: "bold", fontFamily: "inherit", fontSize: "inherit", padding: 0, textAlign: "center", textTransform: 'uppercase', color: 'inherit' , cursor: "text"}}>{formData.fatherName}</span> and 
                     Smt. <span contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, motherName: e.currentTarget.textContent || ""})} style={{ border: "none", outline: "none", background: "transparent", fontWeight: "bold", fontFamily: "inherit", fontSize: "inherit", padding: 0, textAlign: "center", textTransform: 'uppercase', color: 'inherit' , cursor: "text"}}>{formData.motherName}</span> is/was a bonafide student of this institution.
                  </p>
                  <p style={{ margin: '0 0 15px 0', textIndent: '0' }}>
                     His/Her Date of Birth according to the Admission Register maintained in the school is recorded as <span contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, dobNum: e.currentTarget.textContent || ""})} style={{ border: "none", outline: "none", background: "transparent", fontWeight: "bold", fontFamily: "inherit", fontSize: "inherit", padding: 0, textAlign: "center", fontSize: '22px', color: 'inherit' , cursor: "text"}}>{formData.dobNum}</span> &nbsp;(in words: <input name="dobWords" value={formData.dobWords} onChange={handleChange} placeholder="e.g. Fifteenth of August Two Thousand and Ten" className="tc-dotted-input" style={{ width: '500px', border: 'none', borderBottom: '1.5px dotted #000', outline: 'none', background: 'transparent', fontWeight: 'bold', fontSize: '18px', padding: '0 4px', textAlign: 'left', fontFamily: 'inherit' }} />).
                  </p>
                  <p style={{ margin: '0 0 15px 0', textIndent: '0' }}>
                     He/She is/was studying in Class <strong><span contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, className: e.currentTarget.textContent || ""})} style={{ border: "none", outline: "none", background: "transparent", fontWeight: "bold", fontFamily: "inherit", fontSize: "inherit", padding: 0, textAlign: "center", color: 'inherit' , cursor: "text"}}>{formData.className}</span></strong> at the time of issuing this certificate.
                  </p>
                  <p style={{ margin: '0 0 15px 0', textIndent: '0' }}>
