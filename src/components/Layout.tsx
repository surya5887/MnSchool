...
import { LayoutDashboard, Users, LogOut, Bell, GraduationCap, Settings, BookOpen, UserPlus, CalendarCheck, ShieldAlert, FileText, AlertTriangle, Bus, Zap, Clock, Library as LibraryIcon, Menu, X, User } from 'lucide-react'; 
