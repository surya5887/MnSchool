...
if (startIndex !== -1 && endIndex !== -1) {
            ...
            {loading ? (
              ...
              <motion.div 
                ...
                style={{ 
                  ...
                  borderRadius: '16px', 
                  padding: '20px',
                  boxShadow: selectedStudents.includes(student.id as string) ? '0 0 0 2px var(--primary), 0 4px 12px rgba(37,99,235,0.1)' : '0 2px 12px rgba(0,0,0,0.04)',
  ...
  // Inject mobile responsiveness CSS for grid
  ...
  fs.writeFileSync(filePath, newContent.replace('      {/* Secure Delete Modal */}', cssInjection), 'utf8');
  console.log("Successfully replaced table with grid layout.");
} else {
